...
class EditVerificationController extends GetxController {
  ...
  void makeLogin() async {
    ...
    try {
      ...
      dbResult = await databaseService.updateUserData(
        oldEmail: oldemail,
        newName: name,
        newEmail: email,
    ...
    if (dbResult == null) {
      ...
      mySuccessDialog("Successfully Updated!\nPlease log in to continue!",
          true, Colors.green);
    } else {
