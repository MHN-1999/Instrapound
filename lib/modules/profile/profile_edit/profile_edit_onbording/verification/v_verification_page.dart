...
import 'package:instrapound/modules/profile/profile_edit/profile_edit_onbording/verification/c_verification_page.dart';
...
class EditVerificationPage extends StatelessWidget {
  const EditVerificationPage({super.key});

  @override
  Widget build(BuildContext context) {
    EditVerificationController controller =
        Get.put(EditVerificationController());
