...
import 'package:instrapound/modules/profile/profile_edit/profile_edit_onbording/captcha/c_captcha.dart';
import 'package:local_captcha/local_captcha.dart';

import '../../../../../_common/c_datacontroller.dart';

class EditCaptchaPage extends StatelessWidget {
  const EditCaptchaPage({super.key});

  @override
  Widget build(BuildContext context) {
    EditCaptchaController controller = Get.put(EditCaptchaController());
    return Scaffold(
