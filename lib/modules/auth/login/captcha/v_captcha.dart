...
import 'package:instrapound/modules/auth/login/captcha/c_captcha.dart';
import 'package:local_captcha/local_captcha.dart';

import '../../../../_common/c_datacontroller.dart';

class LoginCaptchaPage extends StatelessWidget {
  const LoginCaptchaPage({super.key});

  @override
  Widget build(BuildContext context) {
    LoginCaptchaController controller = Get.put(LoginCaptchaController());
    return Scaffold(
