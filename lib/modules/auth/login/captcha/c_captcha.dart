...
import 'package:instrapound/modules/auth/login/verification/v_verification_page.dart';
import 'package:instrapound/modules/auth/sign_up/v_sign_up.dart';
import 'package:local_captcha/local_captcha.dart';

import '../../../../_common/c_datacontroller.dart';

class LoginCaptchaController extends GetxController {
  ...
  void onClickNext() async {
    ...
    if (result != null) {
      ...
      if (result == "This email has already registered!") {
        ...
        Get.to(() => const LoginVerificationPage())?.whenComplete(() {
          xValidCaptcha.value = false;
          txtCaptcha.clear();
          localCaptchaController.refresh();
          _resetCaptchaTimer();
      ...
      mySuccessDialog(
          "You don't have an account with this email.", false, Colors.red);
    }
  }
}
