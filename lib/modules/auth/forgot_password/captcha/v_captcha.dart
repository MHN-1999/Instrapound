...
import 'package:instrapound/modules/auth/forgot_password/captcha/c_captcha.dart';
import 'package:local_captcha/local_captcha.dart';

import '../../../../_common/c_datacontroller.dart';

class ForgotCaptchaPage extends StatelessWidget {
  const ForgotCaptchaPage({super.key});

  @override
  Widget build(BuildContext context) {
    ForgotCaptchaController controller = Get.put(ForgotCaptchaController());
    return Scaffold(
